...
public class OvalDrawOperation extends ShapeDrawOperation {

    public OvalDrawOperation(double x, double y, double width, double height, double lineWidth, Paint strokeColor, Paint fillColor) {
